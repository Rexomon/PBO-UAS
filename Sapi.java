...
public class Sapi extends Hewan {
    ...
    public void tambahDataHewan() {
        JFrame tambahDataFrame = new JFrame("Tambah Data Sapi");
    ...
    public void ubahDataHewan() {
        JFrame ubahDataFrame = new JFrame("Ubah Data Sapi");
    ...
    public void beriMakan(int jumlahMakanan) {
        JFrame beriMakanFrame = new JFrame("Beri Makan Sapi");
        ...
        btnSubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "Sapi diberi makan " + jumlahMakanan + " kg pakan");
    ...
    public void produksiSapi(LaporanProduksi laporanProduksi) {
        JFrame produksiFrame = new JFrame("Produksi Sapi");
        ...
        JLabel lblNama = new JLabel("Nama Sapi:");
        JTextField txtNama = new JTextField();
